   ...
   <h2><b>View Upload File Data Screen</b></h2>
	...
	if(res != null){
		out.println("<center><font face=verdana color=red>"+res+"</center></font>");
			...
			<th>Download</th> <th>Secret Data Verification</th>
			<tr>
	<%
	String user = (String)session.getAttribute("user");
	Connection con = DBConnection.getCon();
	Statement stmt = con.createStatement();
	ResultSet rs = stmt.executeQuery("select * from filedata");
	while(rs.next()){
		user = rs.getString(1);
	...
	<td><a href="SecretData.jsp?t11=<%=user%>&t2=<%=file%>"><font size="3" color="black">Click Here</font></a></td>
	<%}%>
	</tr>
	</table>
