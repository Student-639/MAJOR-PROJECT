...
<div id="wrapper">
   ...
   <h2><b>View Resource Consumption Screen</b></h2>
	...
	if(res != null){
		out.println("<center><font face=verdana color=red>"+res+"</center></font>");
			...
			<tr><th>Owner Name</th><th>Access Username</th><th>Filename</th>
			<th>Access Time</th>
			<tr>
	<%
	...
	ResultSet rs = stmt.executeQuery("select * from consumption where owner_name='"+user+"'");
	while(rs.next()){
		user = rs.getString(1);
		String access = rs.getString(2);
		String file = rs.getString(3).toString();
		String time = rs.getTimestamp(4).toString();
		%>
